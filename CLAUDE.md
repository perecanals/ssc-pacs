...
│   └── orthanc_users.json    # Generated by scripts/admin/manage_users.py — never edit manually
...
**Auth:**
- Orthanc: `orthanc_users.json` (plaintext, generated by `scripts/admin/manage_users.py`).
...
- `scripts/admin/manage_users.py` is the single provisioning tool for both auth systems.
