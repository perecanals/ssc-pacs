...
Usage:
    python scripts/one_off/rename_dataset_value.py --from-value lvo --to-value 'CRISP2/LVO'
    python scripts/one_off/rename_dataset_value.py --from-value lvo --to-value 'CRISP2/LVO' --execute
...
After renaming, remember:
  - the live image_integration_protocols/execute_image_integration_protocol.yaml
