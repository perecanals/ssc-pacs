...
- **`orthanc_users.json`**: plaintext `RegisteredUsers` file required by Orthanc;
  generated by `scripts/admin/manage_users.py`, not meant for manual editing, and should stay
...
| File | Purpose |
|------|---------|
| `scripts/admin/manage_users.py` | Manage PACS users in PostgreSQL and regenerate `orthanc_users.json` |
...
├── orthanc_users.json            # Generated by scripts/admin/manage_users.py
