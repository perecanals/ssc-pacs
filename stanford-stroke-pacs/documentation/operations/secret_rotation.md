...
# 1. Change the password via manage_users.py (the single provisioning tool).
...
- **Editing `orthanc_users.json` manually.** Don't. `manage_users.py` is
