...
| Admin research-table browser, shared reports and exports | [`reference/data_explorer.md`](reference/data_explorer.md) |
| Data Explorer credentials, limits, recovery and removal | [`operations/data_explorer.md`](operations/data_explorer.md) |
...
| Direct read-only DB access from Python (collaborators, pandas/SQLAlchemy) | [`guides/direct_db_access.md`](guides/direct_db_access.md) |
